...
function L(e2) {
  ...
  i2(e2);
  const l = (0, import_react.useSyncExternalStore)(o2, s2);
...
var z = (n2) => {
  const { isRunning: o2, preventExitTransition: s2, toastRef: r2, eventHandlers: i2, playToast: c2 } = N(n2), { closeButton: d2, children: p2, autoClose: m2, onClick: f2, type: g2, hideProgressBar: y2, closeToast: v2, transition: h2, position: T2, className: E2, style: b2, bodyClassName: I2, bodyStyle: _2, progressClassName: C2, progressStyle: L2, updateId: k2, role: P2, progress: w2, rtl: M2, toastId: x2, deleteToast: A2, isIn: B2, isLoading: O2, closeOnClick: z2, theme: R2 } = n2, S2 = clsx_default("Toastify__toast", `Toastify__toast-theme--${R2}`, `Toastify__toast--${g2}`, { "Toastify__toast--rtl": M2 }, { "Toastify__toast--close-on-click": z2 }), H2 = u(E2) ? E2({ rtl: M2, position: T2, type: g2, defaultClassName: S2 }) : clsx_default(S2, E2), F2 = function(e2) {
    ...
    return false === r3 || (u(r3) ? i3 = r3(l) : (0, import_react.isValidElement)(r3) ? i3 = (0, import_react.cloneElement)(r3, l) : s3 ? i3 = D.spinner() : ((e3) => e3 in D)(o3) && (i3 = D[o3](l))), i3;
...
function q(t2) {
  let s2 = { ...Y, ...t2 };
  const a2 = t2.stacked, [r2, c2] = (0, import_react.useState)(true), d2 = (0, import_react.useRef)(null), { getToastToRender: m2, isToastActive: f2, count: g2 } = L(s2), { className: y2, style: v2, rtl: h2, containerId: T2 } = s2;
  function E2(e2) {
  ...
  return (0, import_react.useLayoutEffect)(() => {
    if (a2) {
      ...
      Array.from(t3).reverse().forEach((e3, t4) => {
        const s3 = e3;
        s3.classList.add("Toastify__toast--stacked"), t4 > 0 && (s3.dataset.collapsed = `${r2}`), s3.dataset.pos || (s3.dataset.pos = o2 ? "top" : "bot");
        const l = a3 * (r2 ? 0.2 : 1) + (r2 ? 0 : n2 * t4);
        s3.style.setProperty("--y", `${o2 ? l : -1 * l}px`), s3.style.setProperty("--g", `${n2}`), s3.style.setProperty("--s", "" + (1 - (r2 ? i2 : 0))), a3 += s3.offsetHeight, i2 += 0.025;
      });
    }
  }, [r2, g2, a2]), import_react.default.createElement("div", { ref: d2, className: "Toastify", id: T2, onMouseEnter: () => {
    a2 && (c2(false), B.pause());
